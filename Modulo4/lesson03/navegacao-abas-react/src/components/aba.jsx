    ...
    <>
      <div className={css.container}>
        <div className={css.tabs}>
          <button className={css.button} id="btn-tab1" onClick={handleContent}>
            Why React?
          </button>
          <button className={css.button} id="btn-tab2" onClick={handleContent}>
            Core Features'
          </button>
          <button className={css.buttonn} id="btn-tab3" onClick={handleContent}>
            Related Resources
          </button>
          <button className={css.button} id="btn-tab4" onClick={handleContent}>
            React Vs JS
          </button>
        </div>
